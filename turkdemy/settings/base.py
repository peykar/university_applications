...
MIDDLEWARE = [
    ...
    "apps.core.middleware.BrandedNotFoundMiddleware",
...
TEMPLATES = [
    {
        ...
        "APP_DIRS": True,
        "OPTIONS": {
            "builtins": ["apps.core.templatetags.localization"],
            "context_processors": [
...
ACCOUNT_ADAPTER = "apps.accounts.adapters.TurkDemyAccountAdapter"
