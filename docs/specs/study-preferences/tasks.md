# Applicant study preferences — tasks
...
- [x] Extract established intended behavior into `PREF` requirements.
- [x] Record current technical design.
- [ ] Resolve any `PREF` findings marked `SPEC GAP` or `CODE GAP` in
