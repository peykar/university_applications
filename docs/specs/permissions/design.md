# Authorization and privacy — technical design

Status: BASELINED

## Design mapping

- This capability is cross-cutting; implementations live in owning apps.
- Follow `docs/architecture/permissions.md`.
- Every protected feature requires positive and negative authorization tests.
