# Agent organizations and active workspace — tasks
...
- [x] Extract established intended behavior into `AGT` requirements.
- [x] Record current technical design.
- [ ] Resolve any `AGT` findings marked `SPEC GAP` or `CODE GAP` in
