...
- [x] Make business previews render the production content builder with realistic sample data.
- [x] Localize shared branded email footer/automated-message chrome.
