...
| `CAT-054` | Optional Program GeneralField mapping | `CAT-T41` | `apps/universities/models.py::Program.general_field` | `tests/test_university_program_json_import.py`; `tests/test_program_filters.py` |
...
| `CAT-057` | Importer never maps GeneralField | `CAT-T44`, `CAT-T46` | `import_programs_for_university` validation/upsert defaults | `UniversityProgramJsonImportTests.test_import_creates_program_academic_unit_languages_and_source_bound_offering`; `test_reimport_preserves_manually_curated_general_field`; `test_import_rejects_general_field_mapping_before_writes` |
