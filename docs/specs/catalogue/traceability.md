...
| `CAT-052` | `CAT-T40` stable locale-independent public filter identity | `CAT-T40` | `apps/public/services/program_filters.py::apply_program_filters`; `apps/public/views.py::_canonical_field_choices`; `apps/public/views.py::home`; public programme/home templates continue submitting `slug_en` while rendering localized labels | `tests/test_program_filters.py` canonical slug identity, localized label, inactive-University field exclusion, homepage dead-link regression |
