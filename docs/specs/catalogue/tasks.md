...
- [x] CAT-T35 (`CAT-050`) Rebuild localized Program public slugs from structured University, Program name, degree, thesis type, and instruction-language data with the
