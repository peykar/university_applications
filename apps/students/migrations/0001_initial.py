            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Student's final high-school grade or GPA in the original grading system, for example 17.5 on a 20-point scale or 3.5 on a 4-point scale.",
                        max_digits=5,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Maximum value of the grading scale used for the high-school grade or GPA, for example 20, 4, 10, or 100.",
                        max_digits=5,
                        null=True,
                    ),
                ),
                ...
                (
                    "passport",
                    models.FileField(blank=True, upload_to="students/passports/"),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="City of residence as free text.",
                        max_length=255,
                    ),
                ),
